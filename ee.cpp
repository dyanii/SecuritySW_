...
void shift_rows(unsigned char *msg)
{
    ...
    msg[2] = msg[10]; msg[10] = tmp; msg[6] = msg[14]; msg[14] = tmp2;
    tmp = msg[15];
...
void inv_shift_rows(unsigned char *msg)
{
    ...
    msg[10] = msg[2]; msg[2] = tmp; msg[14] = msg[6]; msg[6] = tmp2;
    tmp = msg[3];
...
void add_round_key(unsigned char *msg, unsigned char round_key[ROUND+1][16],
    int round)
{
    for(int i=0; i<16; i++)
